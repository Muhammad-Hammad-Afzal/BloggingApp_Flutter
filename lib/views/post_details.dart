...
import 'package:blogging/colors/color.dart';
import 'package:blogging/components/buttons.dart';
import 'package:blogging/components/gesturegector.dart';
import 'package:blogging/components/textforms.dart';
import 'package:blogging/services/upload_to_firebase.dart';
import 'package:blogging/services/utis.dart';
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(child: _image != null ? ClipRect(
                   ...
                   Form(
                       ...
                       child: Column(
                         children: [
                           ...
                           MyTextFormFields(
                               ...
                               hint_text: '\nDescription',
                               Prefix_Icon: Icon(Icons.description_outlined,size: 30,),
                               condation: '',
                               retunt_text: 'enter atleat 6 digits'),
                           SizedBox(height: size.height * .1),
                         ],
                    ...
                    MyButtons(
                        ...
                        VoidCallback: ()async{
                            ...
                            UploadDataFirebase().UploadDataFireStore(
                                _image!.absolute,
                                titlecontroller.text.toString(),
                                descriptioncontroller.text.toString()).then((value){
                              setState(() {
                                loading = false;
                              });
